...
import com.example.filmkita.adapter.TrailerAdapter;
import com.example.filmkita.model.ModelMovie;
import com.example.filmkita.model.ModelTrailer;
...
public class DetailMovieActivity extends AppCompatActivity {
        ...
        TrailerAdapter trailerAdapter;
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    Trailer = findViewById(R.id.rvTrailer);
                    ...
                    movieURL = com.example.filmkita.networking.Api.URLFILM + "" + Id;
            ...
            Glide.with(this)
                    .load(com.example.filmkita.networking.Api.URLIMAGE + Cover)
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                    .into(imgCover);

            Glide.with(this)
                    .load(com.example.filmkita.networking.Api.URLIMAGE + Thumbnail)
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                    .into(imgPhoto);
    ...
    private void getTrailer() {
        progressDialog.show();
        AndroidNetworking.get(com.example.filmkita.networking.Api.BASEURL + com.example.filmkita.networking.Api.MOVIE_VIDEO + com.example.filmkita.networking.Api.APIKEY + com.example.filmkita.networking.Api.LANGUAGE)
