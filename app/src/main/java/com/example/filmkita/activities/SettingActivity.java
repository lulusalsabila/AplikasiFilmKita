...
import com.example.filmkita.NotificationDailyReceiver;
import com.example.filmkita.NotificationReleaseReceiver;
import com.example.filmkita.R;
import com.example.filmkita.preference.SettingPreference;
...
public class SettingActivity  extends AppCompatActivity {
    ...
    private Toolbar toolbar;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            switchReminder = findViewById(R.id.DailyReminder);
            switchRelease = findViewById(R.id.RealeseReminder);
            ...
            switchReminder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (switchReminder.isChecked()) {
                        ...
                        Toast.makeText(getApplicationContext(), "Alarm Harian Aktif", Toast.LENGTH_SHORT).show();
                    } else {
                        notificationDailyReceiver.cancelAlarm(getApplicationContext());
                        settingPreference.setDailyReminder(false);
                        Toast.makeText(getApplicationContext(), "Alarm Harian Nonaktif", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            switchRelease.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (switchRelease.isChecked()) {
                        ...
                        Toast.makeText(getApplicationContext(), "Alarm Perilisan diaktifkan", Toast.LENGTH_SHORT).show();
                    } else {
                        notificationReleaseReceiver.cancelAlarm(getApplicationContext());
                        settingPreference.setReleaseReminder(false);
                        Toast.makeText(getApplicationContext(), "Alarm Perilisan dinonaktifkan", Toast.LENGTH_SHORT).show();
                    }
                }
            });
