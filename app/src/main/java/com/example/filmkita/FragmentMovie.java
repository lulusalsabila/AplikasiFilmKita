...
public class FragmentMovie extends Fragment implements MovieAdapter.onSelectData {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("We Still Loading For The Data");
    ...
    private void setSearchMovie(String query) {
        progressDialog.show();
        AndroidNetworking.get(com.example.filmkita.networking.Api.BASEURL + com.example.filmkita.networking.Api.SEARCH_MOVIE
                + com.example.filmkita.networking.Api.APIKEY + com.example.filmkita.networking.Api.LANGUAGE + com.example.filmkita.networking.Api.QUERY + query)
    ...
    private void getMovie() {
        progressDialog.show();
        AndroidNetworking.get(com.example.filmkita.networking.Api.BASEURL + com.example.filmkita.networking.Api.MOVIE_POPULAR + com.example.filmkita.networking.Api.APIKEY + com.example.filmkita.networking.Api.LANGUAGE)
                .setPriority(Priority.HIGH)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
